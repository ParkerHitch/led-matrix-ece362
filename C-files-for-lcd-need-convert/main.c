...
int MAXAPPS = 10; // read the name
char* APPLIST[10]; // acts like application struct for now
...
void jump_to_app(char* appname, char* authorfirst, char* authorlast)
{
    RUNNING_APP = 1;
    char* by = "By:";
    char* back = "Back";
